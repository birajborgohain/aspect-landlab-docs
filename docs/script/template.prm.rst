...
``template.prm`` input file for ASPECT
========================================
.. code:: text
    ...
    subsection Vertical
        set Magnitude = {gravity_magnitude}
    end
    end
