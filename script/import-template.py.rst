...
``import-template.py`` input file for Landlab
===============================================
...
.. code:: python
    ...
    sys.path.append(
        "/Users/biraj/software/template_Landlab_denial_90296f6_test/aspect/contrib/python/scripts"
    )
    ...
    # =========================
            ...
            # -------------------------------------------------
            cwd = os.getcwd()
            outputs_root = os.path.join(cwd, "output")
